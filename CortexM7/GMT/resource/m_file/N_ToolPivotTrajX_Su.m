function Ptraj = N_ToolPivotTrajX_Su(Phome,pivot,ToolPoseStart, alpha, beta,theta, Tf,Ts, TimeScaling)
% %--Given ----------------------------------
...
theta = 4.0*pi/180;    %% -4.297183463481174<=theta<=4.182591904455009;
Tf = 1.5;
Ts = 0.01;
TimeScaling = '3';
