function Ptraj = N_ToolPivotTrajZ_Su(Phome,pivot,ToolPoseStart, alpha, beta,theta, Tf,Ts, TimeScaling)
% %--Given ----------------------------------
...
% theta = 8.0*pi/180;    %% -8.537071147449266<=theta<=8.422479588423101;
% Tf = 1.5;
% Ts = 0.01;
% TimeScaling = '3';
