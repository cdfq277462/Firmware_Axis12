 ...
 *
 *   MCI_DCACHE_MAINTENANCE:       0U  disable MCI DCache maintenance operations
 *                                 1U   enable MCI DCache maintenance operations
 *     - default value:            1U
 *
 * Note:
...
#include "MCI_STM32H7.h"

#define ARM_MCI_DRV_VERSION ARM_DRIVER_VERSION_MAJOR_MINOR(1,6)  /* driver version */
...
#define MCI_DCACHE_MAINTENANCE    (0U)
#endif
